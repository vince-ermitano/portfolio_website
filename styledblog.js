...
function updateDisplay() {
    ...
    tempStorage.forEach((post) => {
        ...
        editBtn.className = 'edit-button fa-solid fa-pen-to-square';
        editBtn.setAttribute('title', 'Edit post');
        deleteBtn.className = "delete-button fa-solid fa-square-minus"
    ...
    if (blogSection.childNodes.length === 0) {
        document.querySelector('section > h2').innerText = 'No posts as of now :(';
    } else {
        document.querySelector('section > h2').innerText = 'Recent posts';
